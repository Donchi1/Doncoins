...
function Payments() {
  ...
  const handleProve = (e) => {
    ...
    setOpenLoader({ ...openLoader, loading: true, disableBtn: true })
                                ...
                                {openPay.etheruim && (
                                  <div className="pt-2 text-center">
                                    <div className="text-light ">
                                      ...
                                      <p>
                                        You want to invest $
                                        {paymentInfo.paymentAmountData1} to our
                                        platform
                                      </p>
                                      <p>
                                        Etheruim : {newAmount1 && newAmount1}
                                      </p>
                                    </div>
                            ...
                            <form onSubmit={handleProve}>
                              ...
                              >
                                <button
                                  type="submit"
                                  className="btn btn-gradient-purple btn-round  w-100"
                                  disabled={openLoader.disableBtn}
                                >
                                  {openLoader.loading && (
                                    <CircularProgress
